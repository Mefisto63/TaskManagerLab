 ...
 */
public class BirthdayReminderActions implements TaskActions<BirthdayReminder> {

    private TMConnectionPool connectionPool;

    public BirthdayReminderActions(TMConnectionPool connectionPool) {
    ...
    @Override
    public void insert(BirthdayReminder task) throws IOException {
    ...
    @Override
    public void update(BirthdayReminder task){
        Connection connection = connectionPool.get();
