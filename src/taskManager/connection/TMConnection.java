 ...
 */
public class TMConnection implements Connection{
    private Connection connection;
    private TMConnectionPool poolConnection;

    public TMConnection(Connection connection, TMConnectionPool poolConnection) {
    ...
    public void close() {
        poolConnection.putTMConnection(this);
    }
